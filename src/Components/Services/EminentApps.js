...
const EminentAppsContent = ({ closeHandler, showPopup }) => {
  ...
  useEffect(() => {
    ...
    player.setSize(servicesText.offsetWidth / 2, servicesText.offsetHeight);
    player.play();

    document.getElementById("servicesText").appendChild(player.dom);

    window.addEventListener("resize", function () {
      player.setSize(servicesText.offsetWidth, servicesText.offsetHeight);
    });
  }, []);
      ...
      <PopupContainer $border={currentTheme?.schedulePopupTextColor}>
        ...
        >
          ...
          <HeaderTextContainer $color={"#fff"}>
            ...
            <h4>The Future of App Development</h4>
            <h5>
        ...
        >
          <SolutionTextItem id="servicesText">
            <SolutionTextHeaders>
              <p className="greenText">Powerful apps.</p>
        ...
        >
          <div className="violator-strip-content">
            ...
            <p className="strip-copy">
              Full-service app development without the hassle
            </p>

            <p className="strip-sub-copy">
              Easier said than done? Eminent Apps simplifies everything in the
              app-building process. No joke. Forget using complicated software
              to create an app - our team of experts does that for you!
            </p>
          </div>
        </AboutSectionViolatorStrip>
        ...
        >
          <ServicesTextItem className="grid-1 grid-left">
            ...
            <h6>Our Eminent Apps team designs every app and framework. They create the application, its user interface, how it connects to other services, and much more.</h6>
          </ServicesTextItem>
          <ServicesTextItem className="grid-right">
            ...
            <h6>Our team is prepared to work with you on a wide range of projects. We can handle designing and developing high-performance systems to handle millions of hits every day.</h6>
          </ServicesTextItem>
          <ServicesTextItem className="grid-left">
            ...
            <h6>We’ll build a system that is constantly up and running. Our engineers will be responsible for ensuring the high availability, scalability, security of the infrastructure every day with Site Reliability Engineering (SRE), Networking Systems Administration expertise - including performance engineering as well!</h6>
          </ServicesTextItem>
          <ServicesTextItem className="grid-right">
          ...
          <ServicesTextItem className="grid-left">
            ...
            <h6>
              ...
              Content Delivery, and Data Center Operations.
            </h6>
          </ServicesTextItem>
          <ServicesTextItem className="grid-right">
