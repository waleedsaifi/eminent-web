...
export default () => {
    ...
    useEffect(() => {
        getContent(currentStep) && getFadeInFormTen('.footer', getAnimationTimeout(currentStep), () => setTimeout(() => window.stoppedAnimation = true, 1000));
    }, [currentStep])
        ...
        switch (currentStep) {
            ...
            case 1:
                return window.innerWidth < BREAKPOINTS.tablet ?
                    `Scroll right and don't look back into the past` : `Scroll and don't look back to the past`;
        }
    }
    ...
    return ( <
        ...
        $color = {
            screens[currentStep].footerTextColor
        }
        $bottom = {
            getBottom()
        } >
        ...
        /Footer> <
        BlurredFooterBlock className = "blurredFooterBlock"
        $display = {
            getDisplayBlurredBlock()
        }
        $height = {
            getDisplayBlurredBlockHeight()
        }
        /> <
        />
    )
