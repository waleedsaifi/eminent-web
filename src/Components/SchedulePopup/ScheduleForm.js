...
export default ({
    ...
    return ( <
            ...
            <
            TextHolder > Name < span > * < /span></TextHolder >
            <
            StyledInput onInput = {
                onInputHandler
            }
            ...
            name = "name"
            type = "text" /
            > {!isDataValid.name && < ErrorTextHolder $color = {
                    color
                } > This field is required < /ErrorTextHolder>} <
                /StyledLabel> <
                StyledLabel $color = {
                    color
                } >
                <
                TextHolder > Organization < span > * < /span></TextHolder >
                <
                StyledInput
                onInput = {
                    onInputHandler
                ...
                name = "organization"
                type = "text" /
                > {!isDataValid.organization && < ErrorTextHolder $color = {
                        color
                    } > This field is required < /ErrorTextHolder>} <
                    /StyledLabel> <
                    /FormRow> <
                    ...
                    <
                    TextHolder > Job Title < span > * < /span></TextHolder >
                    <
                    StyledInput
                    onInput = {
                        onInputHandler
                    ...
                    name = "jobTitle"
                    type = "text" /
                    > {!isDataValid.jobTitle && < ErrorTextHolder $color = {
                            color
                        } > This field is required < /ErrorTextHolder>} <
                        /StyledLabel> <
                        StyledLabel $color = {
                        ...
                        <
                        TextHolder > Phone < span > * < /span></TextHolder >
                        <
                        StyledInput
                        onInput = {
                            onInputHandler
                        ...
                        name = "phone"
                        type = "text" /
                        > {!isDataValid.phone && < ErrorTextHolder $color = {
                                color
                            } > Please enter a correct phone < /ErrorTextHolder>} <
                            /StyledLabel> <
                            /FormRow> <
                            FormRow >
                            <
                            ...
                            <
                            TextHolder > Email < span > * < /span></TextHolder >
                            <
                            StyledInput
                            onInput = {
                                onInputHandler
                            ...
                            name = "email"
                            type = "text" /
                            > {!isDataValid.email && < ErrorTextHolder $color = {
                                    color
                                } > Please enter a correct email < /ErrorTextHolder>} <
                                /StyledLabel> <
                                /FormRow> <
                                FormRow >
                                <
                                ...
                                <
                                TextHolder > What software or process do you want to improve ? < span > * < /span></TextHolder >
                                    <
                                    StyledInput
                                onInput = {
                                    onInputHandler
                                ...
                                name = "process"
                                type = "text" /
                                > {!isDataValid.process && < ErrorTextHolder $color = {
                                        color
                                    } > This field is required < /ErrorTextHolder>} <
                                    /StyledLabel> <
                                    StyledLabel $color = {
                                    ...
                                    <
                                    TextHolder > Do you have a implementation team
                                    for this project ? < span > * < /span></TextHolder >
                                    <
                                    CustomSelect
                                    color = {
                                        color
                                    ...
                                    <
                                    TextHolder > Message < span > * < /span></TextHolder >
                                    <
                                    StyledTextarea
                                    onInput = {
                                        onInputHandler
                                    ...
                                    name = "message" /
                                    > {!isDataValid.message && < ErrorTextHolder $color = {
                                            color
                                        } > This field is required < /ErrorTextHolder>} <
                                        /StyledLabel> <
                                        /FormRow> <
...
`
  ...
  box-shadow: ${({$valid}) => $valid ? 'none' : '0 0 15px 6px rgba(255, 0, 0, 0.15)'};
  //safari-fix
  -webkit-appearance: none !important;
  -webkit-box-shadow: ${({$valid}) => $valid ? 'none' : '0 0 15px 6px rgba(255, 0, 0, 0.15)'} !important;
...
`
  ...
  &:after {
    ...
    left: 0;
    bottom: 4px;
    background: ${({$color}) => $color ? $color : 'var(--block1-text-primary)'};
...
`
  ...
  select:-webkit-autofill:focus {
    border: 1px solid ${({$color}) => $color ? $color : 'var(--block1-text-secondary)'};
    color: ${({$color}) => $color ? $color : 'var(--block1-text-secondary)'};
    -webkit-text-fill-color: ${({$color}) => $color ? $color : 'var(--block1-text-secondary)'};;
    background: ${({$bg}) => $bg ? $bg[0] : 'var(--popup-bg1)'};
    transition: background-color 5000s ease-in-out 0s;
    box-sizing: border-box;
    border-radius: 3px;
    caret-color: ${({$color}) => $color ? $color : 'var(--block1-text-secondary)'};
  }
