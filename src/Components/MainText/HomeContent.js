    ...
    <Box className="home-page">
            ...
            <Grid container spacing={2}>
              <Grid item xs={12} sm={6} md={4}>
                ...
                <Box className="main-products-text-section">
                  ...
                  <Typography className="main-products-text">
                    Eminent Apps is a simple,
                    <br /> collaborative process to get your
                    <br />
                    FedRAMP and IL5 website built
                    <br /> fast. With so many choices,it's
                    <br /> hard to define your requirements
                    <br /> and know who you can trust to
                    <br /> deliver the best value.
                  </Typography>
              ...
              <Grid item xs={12} sm={6} md={4}>
                ...
                <Box className="main-products-text-section">
                  ...
                  <Typography className="main-products-text">
                    Eminent DApps simplifies the
                    <br /> process by giving you everything
                    <br /> you need to deliver decentralized
                    <br /> blockchain and token solutions in a<br /> fraction of
                    the time at a fraction of
                    <br />
                    the cost. We handle the techincal
                    <br /> details for you from start to finish
                  </Typography>
                  <Typography className="get-started-text">
                    Get started →
                  </Typography>
              ...
              <Grid item xs={12} sm={6} md={4}>
                ...
                <Box className="main-products-text-section">
                  ...
                  <Typography className="main-products-text">
                    Eminent Contracts empowers
                    <br /> entrepreneurs, innovators, and big
                    <br /> thinkers to bring their visions to the
                    <br /> blockchain. Together we will
                    <br /> accelerate the process of creating
                    <br /> a secure and impactful solution that
                    <br /> your target audience loves.
                  </Typography>
                  <Typography className="get-started-text">
                    Get started →
                  </Typography>
      ...
      <Box className="process-section">
        ...
        <Box className="process-text-section">
          <Typography className="process-text">
            Choose a problem and we’ll find you the best
            <br /> solution. Connect by phone, chat, email, and more
          </Typography>
        </Box>
        <Button className="process-demo-btn">Book Demo</Button>
      </Box>
      ...
      <Box>
        <Box className="suite-section">
          <Typography className="suite-heading eminent-green">Suite</Typography>
          <Typography className="suite-subheading">
            With eApps, eDApps, eContracts everything works
            <br /> together so you can deliver powerful experiences.
          </Typography>
          <Typography className="suite-text">
            Together we got this. We are here for you no matter how big your
            dream is.
          </Typography>
          <Button className="suite-demo-btn">Book Demo</Button>
        </Box>
              ...
              <Box className="blog-item">
                ...
                <Box className="blog-text-section">
                  ...
                  <Typography className="blog-text">
                    Quisque varius quis sem
                    <br /> maximus mattis. In pretium
                    <br /> orci sit amet tortor gravida
                  </Typography>
                </Box>
              </Box>
            </Grid>
            ...
            <Grid item md={4} sm={6} xs={12}>
              <Box className="blog-item">
                ...
                <Box className="blog-text-section">
                  ...
                  <Typography className="blog-text">
                    Suspendisse dolor lacus,
                    <br /> pellentesque et finibus quis,
                    <br />
                    hendrerit nec risus justo
                  </Typography>
                </Box>
              </Box>
            </Grid>
            ...
            <Grid item md={4} sm={6} xs={12}>
              <Box className="blog-item">
                ...
                <Box className="blog-text-section">
                  ...
                  <Typography className="blog-text">
                    Amet condimentum magna
                    <br /> facilisis. Etiam feugiat non
                    <br /> metus et scelerisque
                  </Typography>
                </Box>
              </Box>
            </Grid>
        ...
        <Box className="team-section">
          ...
          <Box className="team-text-section">
            ...
            <Typography className="team-subheading">
              We are a small team focused
              <br /> on solving big problems
            </Typography>
